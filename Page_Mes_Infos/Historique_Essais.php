                    ...
                    <?php foreach ($historique as $essai): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="../Essai_individuel.php" method="POST">
                                <input type="hidden" name="essai_indi" value="<?= urlencode($essai['Id_essai']) ?>">
                                <button type="submit" class="validate-btn">Voir l'essai</button>
                                </form>
